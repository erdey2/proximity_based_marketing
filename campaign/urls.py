...
urlpatterns = [
    ...
    path('api/v1/beacons/location', beacon_view.BeaconLocationList.as_view(), name='beacon_location'),
    ...
    path('api/v1/beacons-with-ads/', advertisement_assignment_view.BeaconListWithAdsView.as_view(), name='beacon_ads'),
